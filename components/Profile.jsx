          ...
          >
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
              ...
              <li className="mb-5 ml-6">
                <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-200 rounded-full -left-3 ring-4 sm:ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                ...
                <p
                  className="mb-4 text-sm font-normal text-gray-500 sm:text-base dark:text-gray-400">
          ...
          <div className="lg:w-[500px] sm:m-5 mb-5 ml-2 mr-2 lg:m-5">
            ...
            <motion.div
              ...
              <div>
                ...
                <p
                  className="m-1 text-sm text-gray-500 sm:text-base">
              ...
              <div>
                ...
                <p
                  className="m-1 ml-2 mr-2 text-sm text-gray-500 sm:mr-16 sm:ml-16 lg:mr-5 lg:ml-5 sm:text-base">
