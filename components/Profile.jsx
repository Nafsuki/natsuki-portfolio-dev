...
export default function Profile() {
	return (
		<div className='text-gray-900 dark:text-white overflow-y-scroll overflow-x-hidden shadow-indigo-500/50 shadow-lg my-10 w-[260px] xs:w-[350px] sm:w-[630px] md:w-[740px] lg:w-[1000px] h-[600px] md:h-[700px] border-2 border-dashed rounded-lg'>
			<div className='flex flex-col items-center justify-around border-b-2 xs:flex-row xs:h-[100px]'>
				<h1 className='m-3 text-[35px] sm:text-[40px] leading-9 sm:leading-[40px] font-bold'>
					Natsuki Yamaguchi
				</h1>
			...
			<div className='flex flex-col justify-center lg:flex-row'>
				<div className='flex flex-col lg:w-[500px] my-5 mx-2 sm:m-5 lg:m-5 lg:mr-0'>
					<div className='border rounded-md md:mb-1 lg:mb-0'>
						<h2 className='w-full text-lg font-bold shadow-sm shadow-indigo-500/50 sm:text-xl'>
							Job Experience
						</h2>
					</div>
					<motion.div
					...
					>
						<ol className='relative border-l border-gray-200 dark:border-gray-700'>
							...
							<li className='mb-8 ml-6'>
								...
								<p className='mb-4 text-sm font-normal text-gray-500 sm:text-base dark:text-gray-300'>
									Test suitability and stability of Microsoft services before
									release
								</p>
							</li>
							...
							<li className='mb-5 ml-6'>
								...
								<p className='mb-4 text-sm font-normal text-gray-500 sm:text-base dark:text-gray-300'>
									MATLAB install support for international software users in
									English &#38; Japanese.
								</p>
							</li>
						</ol>
				...
				<div className=''>
					...
					<div className='lg:w-[500px] sm:m-5 mb-5 ml-2 mr-2 lg:m-5'>
						...
						>
							<div>
								...
								<p className='m-1 text-sm text-gray-500 sm:text-base dark:text-gray-300'>
							...
							<div>
								...
								<p className='m-1 ml-2 mr-2 text-sm text-gray-500 sm:mr-16 sm:ml-16 lg:mr-5 lg:ml-5 sm:text-base dark:text-gray-300'>
									ReactJS, NextJS, React Native, TailwindCSS, Styled Components,
									Git, GitHub, Node, GraphQL, Sass
								</p>
							</div>
					...
					<div className='mt-2 mb-5 ml-2 mr-2 flex flex-col lg:w-[500px] sm:m-5 sm:mt-8 lg:m-5'>
						<h3 className='text-lg font-bold border rounded-md shadow-sm shadow-indigo-500/50 sm:text-xl'>
							Education
						</h3>
						...
						>
							<div>
								...
								<p className='m-1 text-sm text-gray-500 sm:text-base dark:text-gray-300'>
									Bachelor of Arts
									<br className='sm:hidden' />- English Literature
								</p>
							</div>
							<div>
								<p className='text-base font-bold sm:text-lg'>
